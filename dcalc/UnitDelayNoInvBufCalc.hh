...
class UnitDelayNoInvBufCalc : public ArcDelayCalc
{
public:
  UnitDelayNoInvBufCalc(StaState *sta);
  ArcDelayCalc *copy() override;
  const char *name() const override { return "unit_noinvbuf"; }
...
protected:
  ArcDcalcResult unitDelayResult(const Pin* drvr_pin,
                                 const LoadPinIndexMap &load_pin_index_map);
};
